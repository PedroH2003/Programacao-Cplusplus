...
Cada caso de teste é uma linha contendo dois números inteiros, N e P, sendo N o número de documentos encontrados pelo Poodle, e P o número de resultados exibidos por página (1 ≤ N ≤ 1.000.000, 1 ≤ P ≤ 100). A entrada termina quando N = P = 0.
