...
int main(){
    ...
    int n, a, b, passenger=0, maxCapacity=0;
    ...
    while(n != 0)
    {
        ...
        maxCapacity = max(maxCapacity, passenger); //irá escolher o maior valor
    ...
    while(n != 0)
    {
        cin >> a >> b;
        ant = (ant - a) + b;
        numTotal.push_back(ant);

        n--;
    }

    sort(numTotal.begin(), numTotal.end());

    cout << numTotal[numTotal.size()-1];
